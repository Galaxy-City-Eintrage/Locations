...
Config.Vehiclekeys = 'vehicles_keys'
...
Config.ImpoundPrice = 1500              -- Impound default value to remove vehicles

Config.DisableBlips = false            -- Disable all blips or show them on your map?
Config.ShortNames = true              -- This config will shorten the names so your blips are much less
Config.startCinematic = 1.3              -- Cinematic Cams being AFK in the garage, it's a beautiful cinematic cam (by default it is 1.3, one and a half minutes)
...
Config.RepairKit = true               -- Enable or disable the 'repairkit' item
...
Config.SoundFiles = {
    ...
    'TroyBoi_-_Say_Yeah',
    'x2mate.com-Capshun, Pryzms - Sense (Copyright Free)-(128kbps)',
    'x2mate.com-Haterade - Go Off (Copyright Free)-(128kbps)',
    'x2mate.com-T-Mass, Krysta Youngs - Regret It (Copyright Free)-(128kbps)',
...
Config.Recovery = {
    coords = {
        ...
        vec3(1187.84, 2645.64, 38.36),
        vec3(105.4, 6613.88, 32.4),
        vec3(-1142.76, -1993.36, 13.16),
        vec3(-1584.72, -838.72, 10.12),
        vec3(1695.88, 4785.28, 42.0),
        vec3(1690.36, 3581.2, 35.64),
        vec3(4502.28, -4530.24, 4.16),
    },
    blip = {
        sprite = 67,
        color = 6,
        scale = 0.6,
        name = '→ Fahrzeug | Reperatur',
        shortRange = true
    },
    price = 5000
}
...
Config.ActionControls = {
    ...
    leftApt = {
        label = 'Letztes Interior',
        codes = { 174 }
    },
    rightApt = {
        label = 'Nächstes Interior',
        codes = { 175 }
    },
    select_menuCoords = {
        label = 'Menu Standort setzen',
        codes = { 47 }
    },
    select_spawnCoords = {
        label = 'Fahrzeug Auspark-Punkt setzen',
        codes = { 74 }
    },
}
